...
// Membuat Node
class BTreeNode {
    int *Kunci;      // Array kunci
    int t;           // Derajat minimum
    int n;           // Jumlah kunci saat ini
    bool leaf;       // True jika leaf

    BTreeNode **C;   // Array child
...
int main() {
    ...
    cout << "Pohon dengan menggunakan B-Tree\n";
    cout << "t = 5\n";
    cout << "---------------------------------\n";
